...
const TrashIcon = ({
  ...
  return (
    ...
    >
      ...
      <g transform="matrix(0.45999999999999985,0,0,0.45999999999999985,138.2400000000001,138.24000720728)">
        <path
        ...
        <path
          d="M64.666,182l23.917,289.072C90.707,494.407,109.97,512,133.393,512h245.215c23.423,0,42.686-17.593,44.824-41.06L447.336,182H64.666z"
          className={styles.white}
        />
      </g>
    </svg>
